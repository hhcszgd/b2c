...
#import "GoodsCell.h"
@interface HFranHeighSellSubCell()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
/**布局类*/
...
@end
@implementation HFranHeighSellSubCell
