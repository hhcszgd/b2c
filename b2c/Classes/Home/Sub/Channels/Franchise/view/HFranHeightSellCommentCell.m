...
#import "HFranHeighSellSubCell.h"
@interface HFranHeightSellCommentCell()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
/**布局类*/
...
- (UICollectionView *)col{
    if (_col == nil) {
        ...
        [_col registerClass:[HFranHeighSellSubCell class] forCellWithReuseIdentifier:@"HFranHeighSellSubCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    HFranHeighSellSubCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"HFranHeighSellSubCell" forIndexPath:indexPath];
