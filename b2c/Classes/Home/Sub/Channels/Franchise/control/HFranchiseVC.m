...
/**商品*/
#import "GoodsCell.h"
@interface HFranchiseVC ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
/**布局类*/
...
- (UICollectionView *)col{
    if (_col == nil) {
        ...
        [_col registerClass:[HFranBannerCell class] forCellWithReuseIdentifier:@"HFranBannerCell"];
        [_col registerClass:[HFranHotBrandCell class] forCellWithReuseIdentifier:@"HFranHotBrandCell"];
...
- (void)viewDidLoad {
    ...
    _h = height;
    _cellArray =
    _cellArray = @[@"HFranBannerCell",@"HFranHotBrandCell",@"HFranOverflowSellCell",@"HFranHeightSellCommentCell",@"HFranCouponCell",@"GoodsCell"];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([_cellArray[indexPath.section] isEqualToString:@"HFranBannerCell"]) {
        return CGSizeMake(screenW, screenW * 0.6);
    }
    if ([_cellArray[indexPath.section] isEqualToString:@"HFranHotBrandCell"]) {
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
    ...
    if ([_cellArray[section] isEqualToString:@"HFranHotBrandCell"]) {
