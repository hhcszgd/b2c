...
#import "GoodsCell.h"
@interface HBSeasonHotSubCell()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
/**布局类*/
...
@end
@implementation HBSeasonHotSubCell
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return CGSizeMake((screenW - 5 *10)/4.0, self.col.frame.size.height);
}
